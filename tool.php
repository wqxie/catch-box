...
<div class="product">
	...
	<div class="project-panel">
		<div class="project-item">
			<div class="tool-box">
				<div class="project-title">Tool 1</div>
				<div class="project-img">
					<?php echo '<img src="'.get_template_directory_uri().'/images/tool1.png">'?>	
				</div>
			</div>
			<div class="tool-tag-panel">
		...
		<div class="project-item">
			<div class="tool-box">
				<div class="project-title">Tool 2</div>
				<div class="project-img">
					<?php echo '<img src="'.get_template_directory_uri().'/images/tool2.png">'?>	
				</div>
			</div>
			<div class="tool-tag-panel">
				<div class="project-tag geography-tag">GEOGRAPHY TAG</div>
		...
		<div class="project-item">
			<div class="tool-box">
				<div class="project-title">Tool 3</div>
				<div class="project-img">
					<?php echo '<img src="'.get_template_directory_uri().'/images/tool3.jpg">'?>	
				</div>
			</div>
			<div class="tool-tag-panel">
				<div class="project-tag geography-tag">GEOGRAPHY TAG</div>
