	...
	<div class="project-panel">
		<div class="project-item">
			<div class="presentation-box">
				<div class="presentation-title">Presentation 1</div>
				<div class="calendar">
					<div class="calendar-month">JUN</div>
					<div class="calendar-date">30</div>
				</div>
				<div class="presentation-summary">
					Audience/Event:Legacy Cities<br>
					Presenter: Erica Raleig		
				</div>
			</div>
			<div class="tag-panel">
		...
		<div class="project-item">
			<div class="presentation-box">
				<div class="presentation-title">Presentation 2</div>
				<div class="calendar">
					<div class="calendar-month">JUN</div>
					<div class="calendar-date">30</div>
				</div>
		...
		<div class="project-item">
			<div class="presentation-box">
				<div class="presentation-title">Presentation 3</div>
				<div class="calendar">
					<div class="calendar-month">JUN</div>
					<div class="calendar-date">30</div>
				</div>
